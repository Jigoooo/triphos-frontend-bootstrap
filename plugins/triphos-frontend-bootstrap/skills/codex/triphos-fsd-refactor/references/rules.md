...
> 이 문서는 plugin 업데이트/릴리즈 흐름에서 최신 FSD 공식 docs와 함께 검토한다.
...
이 문서가 수정되면 plugin 업데이트/릴리즈 흐름에서 최신 FSD 공식 docs와 함께 검토한다. 규칙을 의식적으로 공식과 다르게 유지하는 부분은 "왜" 섹션에 이유가 기록돼 있어야 한다.
