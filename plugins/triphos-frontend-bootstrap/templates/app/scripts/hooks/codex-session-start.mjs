...
const additionalContext = [
  ...
  'Treat docs/README.md as the system of record for architecture, product intent, decisions, plans, and quality.',
  'For non-trivial work, create docs/plans/active/<date>-<slug>/PLAN.md, STATUS.md, DECISIONS.md, and VERIFICATION.md.',
